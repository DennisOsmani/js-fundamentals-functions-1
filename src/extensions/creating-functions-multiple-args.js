...
function exclamationMarks(word, amount) {
  const exes = "!".repeat(amount);
  return word.toUpperCase() + exes;
}
...
module.exports = {
  a: toArray, // 1. change undefined to be the name of the function defined to create the range of numbers (the first todo)
